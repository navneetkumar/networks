...
import edu.uw.cs.cse461.net.tcpmessagehandler.TCPMessageHandlerServiceInterface;
		...
		try {
			...
			while ( true ) {
				...
				try {
					...
					TCPMessageHandlerServiceInterface tcpmhService = (TCPMessageHandlerServiceInterface)NetBase.theNetBase().getService("tcpmhservice");
					if ( tcpmhService == null ) throw new Exception("Required service tcpmhservice isn't loaded");
					tcpMessageHandlerSocket = tcpmhService.createTCPMH(tcpSocket);
