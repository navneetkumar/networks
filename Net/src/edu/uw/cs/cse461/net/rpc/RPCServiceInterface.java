...
public interface RPCServiceInterface {
	...
	/**
	 * Registers the handler for a callback when an incoming RPC names the service and method given by the arguments.
	 * Any previously registered handler is forgotten.
	 ...
	 * @throws Exception An argument is null.
	 */
