...
public class SampledStatistic {
	 ...
	 *
	 */
	public static abstract class SampleSet {
	...
	public static class ElapsedTime {
		...
		/**
		 * Reset one sample set
		 */
		public static void clear(String key) {
		  mSampleSetManager.remove(key);
		}
		 ...
		 * information.
		 */
		public static String meanString() { return mSampleSetManager.meanString(); }
	...
	public static class TransferRate {
		...
		/**
		 * Reset a particular sample set
		 * @param key
		 */
		public static void clear(String key) { mSampleSetManager.remove(key); }
